...
import './ChatBot.css'
import chatbot from '../HomePage/chatbot.png'
...
function ChatBot() {
  ...
  const handleInput = () => {
    ...
    let words11 = new RegExp(signAsk);
    if (words11.test(document.querySelector("#input").value)) {
      getBotMessage.innerText = "Typing...";
      setTimeout(() => {
        getBotMessage.innerText = "It's very easy. First, you have to go to the login page. Then, you can enter your email and password. Afterward, click the login button. You will then be able to log in to the Queens Furniture shop";
        inputRef.value = ""; // clear the input
      }, 2000);
    }
    let signUpAsk = [
    ...
    let words12 = new RegExp(signUpAsk);
    if (words11.test(document.querySelector("#input").value)) {
      getBotMessage.innerText = "Typing...";
      setTimeout(() => {
        getBotMessage.innerText = "It's very easy. First, you have to go to the registration page. Then, you can enter your email and password. After that, click the 'Register' button. You will then be able to register for the Queens Furniture shop.";
        inputRef.value = ""; // clear the input
      }, 2000);
    }
    let categorypAsk = [
    ...
    let words13 = new RegExp(categorypAsk);
    if (words13.test(document.querySelector("#input").value)) {
      getBotMessage.innerText = "Typing...";
      setTimeout(() => {
        getBotMessage.innerText = "We have so many categories, such as tables, beds, sofas, chairs, and wardrobes";
        inputRef.value = ""; // clear the input
      }, 2000);
    }
    let deliverypAsk = [
      "Do you deliver orders to home?",
    ];
    let words14 = new RegExp(deliverypAsk);
    if (words14.test(document.querySelector("#input").value)) {
      getBotMessage.innerText = "Typing...";
      setTimeout(() => {
        getBotMessage.innerText = "We deliver your order to your home within 7 days";
        inputRef.value = ""; // clear the input
      }, 2000);
    }
    let paymentAsk = [
    ...
    let words15 = new RegExp(paymentAsk);
    if (words15.test(document.querySelector("#input").value)) {
      getBotMessage.innerText = "Typing...";
      setTimeout(() => {
        getBotMessage.innerText = "We accept credit cards, debit cards, and PayPal";
        inputRef.value = ""; // clear the input
      }, 2000);
    }
    let discountAsk = [
    ...
    let words16 = new RegExp(discountAsk);
    if (words16.test(document.querySelector("#input").value)) {
      getBotMessage.innerText = "Typing...";
      setTimeout(() => {
        getBotMessage.innerText = "Yes, we provide discounts on selected items throughout the year.";
        inputRef.value = ""; // clear the input
      }, 2000);
    }
    let owner = [
    ...
    if (words9.test(document.querySelector("#input").value)) {
      getBotMessage.innerText = "Typing...";
      setTimeout(() => {
        getBotMessage.innerText = "The owner of this bot is Queens Furniture";
        inputRef.value = ""; // clear the input
      }, 2000);
    }

    let owner2 = [
      "Who's Queens Furniture|who's Queens Furniture|Who is Queens Furniture|who is Queens Furniture",
    ];
    ...
    if (words10.test(document.querySelector("#input").value)) {
      ...
      setTimeout(() => {
        getBotMessage.innerText =
          "Queens Furniture is furnitures and interial desining shop";
        inputRef.value = ""; // clear the input
      }, 2000);
    }
      ...
      <div className="wrapper">
        <div className="content">
          <div className="header">
            ...
            <div className="right">
              <div className="name">Queens Furniture ChatBot</div>

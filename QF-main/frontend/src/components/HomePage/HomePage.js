                ...
                <div className="column" style={{display:"flex" , justifyContent:"space-around"}}>
                  <div>
                    ...
                    <select style={{width:"20vw"}}
                            name="Material"
                    >
                      <option value="m1">Teak</option>
                      <option value="m2">Mahogany</option>
                      <option value="m3">Bulu</option>
                      <option value="m4">Calamander</option>
                      <option value="m5">Acacia</option>
                    </select>
                  </div>
                  <div>
                    <label htmlFor="">
                    ...
                    <select style={{width:"20vw"}}
                            name="Color"
                    >
                      <option value="c1">Larch teak</option>
                      <option value="c2">Jak wood</option>
                      <option value="c3">Kumbuk</option>
                      <option value="c4">Walnut</option>
                      <option value="c5">Black</option>
                      <option value="c5">Green</option>
                      <option value="c5">White</option>
                    </select>
                  </div>
                </div>
